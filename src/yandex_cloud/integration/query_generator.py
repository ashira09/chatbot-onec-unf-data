...
class QueryGenerator:
    ...
    def __init__(
        ...
        self.base_instructions = (
            ...
            "ПРАВИЛА:\n"
            "1. Перед генерацией запроса мысленно проверь: существует ли указанная таблица в подключенном индексе?\n"
            "2. Если нужная таблица или поле не найдены в контексте - генерируй корректный запрос на основе имеющихся в контексте таблицах (даже если он будет не соответствовать запросу пользователя, главное, чтобы он был корректный).\n"
